...
const Home = () => {
  return (
    <div className='w-full min-h-screen bg-slate-950 text-white px-6 bg-[url(https://i.pinimg.com/736x/a7/a5/77/a7a577becc087261dc87e25562f3080e.jpg)] relative bg-cover bg-center bg-no-repeat'>
