...
// const Skills = () => {
//   return (
//     <div className="w-full md:min-h-screen  bg-black md:p-40 ">
//         <div className="md:min-h-screen  mx-auto">

//             <div className='flex flex-col justify-center text-center font-bold'>
//                <h1 className='text-white text-2xl'>WHAT WE OFFER</h1>
//                <h1 className='flex justify-center md:text-4xl font-bold '> <span className='text-white'>Everything you need to level up</span> <span className='text-blue-500'>level up</span> </h1>
//             </div>

//             <div className="grid md:grid-cols-3 grid-cols-1 gap-12 pt-10 ">

//                 <div className="box1 bg-slate-950 rounded-2xl  p-10 md:col-span-2 h-96 cursor-pointer border-2 shadow-md hover:border-orange-300 transition-colors duration-200">
//                     <div className="flex justify-between text-gray-500">
//                         <h1>COURSES</h1>
//                         <h1>40+ courses</h1>
//                     </div>
...
//                           <h1 className='text-white text-3xl font-bold'>web Development</h1>
//                           <h1 className='text-gray-500 font-medium text-xl'>From HTML basics to full-stack apps.React ,next,Node</h1>
//                     </div>
//                     <div className='flex text-blue-500 gap-2 text-xl font-semibold mt-12'>
//                     <a>Explore</a>
//                     <FaArrowRight className='mt-1' />
//                     </div>
//                 </div>

//                  <div className="box1 bg-slate-950 rounded-2xl  p-10 h-96 cursor-pointer border-2 shadow-md hover:border-indigo-600 transition-colors duration-200 ">
//                     <div className="flex justify-between text-gray-500">
//                         <h1>COURSES</h1>
//                         <h1>40+ courses</h1>
//                     </div>
//                     <LuBrain className="text-6xl text-violet-500 my-6"LuBrain />
//                     <div className='flex flex-col gap-10'>
...
//                  <div className="box1 bg-slate-950 rounded-2xl  p-10 h-96 cursor-pointer border-2 shadow-md hover:border-violet-600 transition-colors duration-200">
//                     <div className="flex justify-between text-gray-500">
//                         <h1>COURSES</h1>
//                         <h1>40+ courses</h1>
//                     </div>
//                     <SiDjango className="text-6xl text-green-400 my-6"LuBrain/>
//                     <div className='flex flex-col gap-10'>
//                           <h1 className='text-white text-2xl font-bold'>web Development</h1>
//                           <h1 className='text-gray-500 font-medium text-xl'>From HTML basics to full-stack apps.React ,next,Node</h1>
//                     </div>
...
//                 <div className="box1 bg-slate-950 rounded-2xl  p-10 col-span-2 h-96 cursor-pointer border-2 shadow-md hover:border-green-600 transition-colors duration-200">
//                     <div className="flex justify-between text-gray-500">
//                         <h1>COURSES</h1>
//                         <h1>40+ courses</h1>
//                     </div>
